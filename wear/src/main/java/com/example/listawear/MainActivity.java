...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        items.add(new ItemsList(R.drawable.playstation, "PlayStation", "Compra de PlayStation"));
        items.add(new ItemsList(R.drawable.xbox_logo, "Xbox", "Compra de Xbox"));
        items.add(new ItemsList(R.drawable.nintendo, "Nintendo", "Compra de Nintendo"));
        items.add(new ItemsList(R.drawable.pc, "Pc", "Compra de Pc"));
        items.add(new ItemsList(R.drawable.mobile_app, "SmartPhone", "Compra de SmartPhone"));
